...
public class VariousSkew {

    public static void main(String[] args) throws IOException {

        //the skew
        int skewness = Integer.parseInt(args[0]);
        int N = 100;
        //add zipf
        double zipf = 0.8;
        int P = 3 * N;
        ...
        String ofile = "/home/people/lcheng/storage/GenData/skew/" + skewness + "_R";
        ...
        ofile = "/home/people/lcheng/storage/GenData/skew/" + skewness + "_S";
        ...
        ofile = "/home/people/lcheng/storage/GenData/skew/" + skewness + "_A";
        owrite = new FileWriter(ofile);
        for (int i = 0; i < N - 1; i++) {
        ...
        System.out.println("The input data information has been generated for skew " + skewness);
