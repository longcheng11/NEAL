...
public class VariousNode {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String ofile = "/home/people/lcheng/storage/GenData/node/" + N + "_R";
        ...
        ofile = "/home/people/lcheng/storage/GenData/node/" + N + "_S";
        ...
        ofile = "/home/people/lcheng/storage/GenData/node/" + N + "_A";
        owrite = new FileWriter(ofile);
        for (int i = 0; i < N - 1; i++) {
        ...
        System.out.println("The input data information has been generated for node " + N);
